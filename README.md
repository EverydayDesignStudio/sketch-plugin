...
### Dominant Color
Easily create a collection of boxes from array of RGB and array of percentages. This data comes from the kmeans color detection script for Capra.
...
- [ ] Add automatic color detection from simply selecting a picture
